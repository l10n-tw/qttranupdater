...
# please contact oswald.buddenhagen@gmx.de
branchMap = "http://l10n-files.qt.io/l10n-files/branch-map.txt"

# The filename format. If the format is modified on remote, please
# edit here and make a Pull Request.
filenameFormat = "{component}_{langcode}.ts"

# The template filename. It will be applied to
...
# Edit it and make a Pull Request if something changed.
# It can't automatically update, might outdated
# if nobody to update that.
#
# If `component_name` is `all`, it will recursive the components listed
# in this list.
compList = [
...
arg.add_argument(
  ...
  action="store",
  type=str,
  help=_("""e.g: qtbase, qtscript, assistant, designer...
...
arg.add_argument(
  ...
  action="store",
  type=str,
  help=_("""e.g: zh_TW, zh_CN, ar, ko, pl...
...
arg.add_argument(
  ...
  # It will appear like `[--branch branch_name]`.
  metavar=_("branch_name"),
  help=_("""e.g: qt5-current, qt5-stable...
...
def mergeTS(templateFile, langFile, targetLang, destFile="", preserveLocation=True):
  ...
  It is needed to install Qt Linguist 5,
  otherwise the merge process will fail.
